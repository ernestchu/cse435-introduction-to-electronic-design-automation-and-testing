We'll use some acronyms, explained in Table 3, in the following D-algorithm procedure, shown in Table 4.
...
\begin{tabular}{llp{6.5cm}}
  ...
  \specialrule{.1em}{.05em}{.05em} 
\end{tabular}
\captionof{table}{Acronym for D-algorithm procedure}
\end{center}
...
% \multicolumn{1}{|c|}{a} & b & c & d & e & f & g & h \\
  ...
  \specialrule{.1em}{.05em}{.05em} 
\end{tabular}
\captionof{table}{The procedure for D-algorithm}
\end{center}
